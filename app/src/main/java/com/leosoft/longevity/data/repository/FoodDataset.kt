...
internal object FoodDataset {
    ...
    private fun coreProteinSeeds(): List<FoodSeed> = listOf(
    ...
    private fun grainAndProduceSeeds(): List<FoodSeed> = listOf(
    ...
    private fun legumeAndFatSeeds(): List<FoodSeed> = listOf(
